    ...
    <div className="container mx-auto p-4 space-y-6 bg-gradient-to-br from-purple-900 via-red-900 to-yellow-900 min-h-screen text-white">
      <header className="flex justify-between items-center mb-6">
        ...
        <div className="h-12 w-12 bg-yellow-400 rounded-full flex items-center justify-center">
          <span className="text-red-900 font-bold">JD</span>
        </div>
      </header>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div key={index} className="bg-gradient-to-br from-yellow-600 to-yellow-800 border-4 border-yellow-400 shadow-lg overflow-hidden group p-4 rounded-lg">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="col-span-2 md:col-span-1 bg-gradient-to-br from-red-800 to-red-900 border-4 border-yellow-400 shadow-lg p-4 rounded-lg">
        ...
        <div className="col-span-2 md:col-span-1 bg-gradient-to-br from-purple-800 to-purple-900 border-4 border-yellow-400 shadow-lg p-4 rounded-lg">
          <h2 className="text-2xl font-bold text-yellow-400 mb-4">Recent Matches</h2>
              ...
              <div key={index} className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="h-8 w-8 bg-yellow-400 rounded-full flex items-center justify-center">
                    <span className="text-indigo-900 font-bold">{match.opponent[0]}</span>
                  </div>
                  <div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="bg-gradient-to-br from-blue-800 to-blue-900 border-4 border-yellow-400 shadow-lg p-4 rounded-lg">
          <h2 className="text-2xl font-bold text-yellow-400 mb-4">Balance Management</h2>
          <div className="space-y-4">
        ...
        <div className="bg-gradient-to-br from-indigo-800 to-indigo-900 border-4 border-yellow-400 shadow-lg p-4 rounded-lg">
          <h2 className="text-2xl font-bold text-yellow-400 mb-4">Find Users to Bet</h2>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              {['BetMaster', 'LuckyGamer', 'HighRoller'].map((user, index) => (
                <div key={index} className="flex items-center justify-between bg-indigo-700 p-2 rounded-lg">
                  <div className="flex items-center space-x-2">
                    <div className="h-8 w-8 bg-yellow-400 rounded-full flex items-center justify-center">
                      <span className="text-indigo-900 font-bold">{user[0]}</span>
                    </div>
                    <span>{user}</span>
                  </div>
                  <Button size="small" className="bg-yellow-400 hover:bg-yellow-500 text-indigo-900">
                    Challenge
                  </Button>
                </div>
              ))}
      ...
      <div className="bg-gradient-to-br from-green-800 to-green-900 border-4 border-yellow-400 shadow-lg p-4 rounded-lg">
          ...
          {[
            ...
            <div key={player.rank} className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div className="h-8 w-8 bg-yellow-400 rounded-full flex items-center justify-center">
                  <span className="text-indigo-900 font-bold">{player.name[0]}</span>
                </div>
      ...
      <div className="bg-gradient-to-br from-orange-800 to-orange-900 border-4 border-yellow-400 shadow-lg p-4 rounded-lg">
        <h2 className="text-2xl font-bold text-yellow-400 mb-4">Top Win Ratios</h2>
        <div className="space-y-4">
          {[
